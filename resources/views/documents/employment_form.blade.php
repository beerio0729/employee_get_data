...
$postEmp_salary = number_format($post_emp->salary, 2);
$postEmp_salaryText = thaiBahtText($post_emp->salary);
$postEmp_manager = User::find($post_emp->manager_id)->userHasoneWorkStatus->workStatusHasonePostEmp->postEmpBelongToOrg->name_th;
    ...
    <div id="main_pdf" class="page-container">
        ...
        <div class="intro-section">
            ...
            <div class="text-indent">
                ...
                <i>{{$postEmp_manager}}</i> รายละเอียดเป็นไปตามข้อตกลงและเงื่อนไขที่ระบุในสัญญานี้
        ...
        <div class="detail-section">
            ...
            <div class="flex_detail_container">
                ...
                <div class="detail"><B>การจ้างงานพนักงาน</B> บริษัทตกลงว่าจ้างพนักงานและพนักงานยอมรับการจ้างงานกับบริษัท เริ่มตั้งแต่วันที่ <i>{{$postEmp_hired_at()}}</i> (“วันที่มีผลบังคับใช้”) รายละเอียดเป็นไปตามข้อตกลงและเงื่อนไข</div>
            </div>
            <div class="flex_detail_container">
                <div class="num">1.2</div>
                <div class="detail"><B>ระยะเวลาทดลองงาน</B> พนักงานจะต้องผ่านระยะเวลาทดลองงาน 119 (หนึ่งร้อยสิบเก้า) วัน เริ่มตั้งแต่วันที่สัญญานี้มีผลบังคับใช้ และในระหว่างระยะเวลาทดลองงานนี้ บริษัทอาจบอกเลิกสัญญาได้โดยแจ้งพนักงานล่วงหน้าเป็นลายลักษณ์อักษรไม่น้อยกว่า 1 (หนึ่ง) งวดเงินเดือน ซึ่งถือเป็นดุลพินิจฝ่ายเดียวของบริษัทที่จะพิจารณาว่า ตำแหน่งหน้าที่ของพนักงานที่บริษัทแจ้งหรือประกาศไปไม่เหมาะกับพนักงาน หรือพนักงานไม่ปฏิบัติตามสัญญาหรือข้อบังคับการทำงานหรือจรรยาบรรณในการดำเนินธุรกิจของบริษัท ในส่วนพนักงานผู้ประสงค์บอกเลิกสัญญานี้ จะต้องแจ้งบริษัทล่วงหน้าเป็นลายลักษณ์อักษรไม่น้อยกว่า 1 (งวด) เงินเดือน เช่นเดียวกัน</div>
            </div>
            ...
            <div class="flex_detail_container">
                ...
                <div class="detail">
                    พนักงานจะปฏิบัติงานในตำแหน่ง <i>{{$postEmp_position()}}</i> ซึ่งจะต้องรายงานต่อผู้บังคับบัญชา ตำแหน่ง <i>{{$postEmp_manager}}</i> และจะต้องปฏิบัติงานและรับผิดชอบหน้าที่ของพนักงานตามขอบเขตการทำงานตามที่ระบุในเอกสารแนบท้าย ตลอดระยะเวลาสัญญานี้
                </div>
            </div>
            <div class="flex_detail_container">
            ...
            <div class="flex_detail_container">
                ...
                <div class="detail">
                    ...
                    เป็นจำนวนเงิน <i>{{$postEmp_salary}}</i> บาท (<i>{{$postEmp_salaryText}}</i>)
            ...
            <div class="flex_detail_container">
                ...
                <div class="detail">
                    <B>สวัสดิการของพนักงาน</B> พนักงานจะได้รับสวัสดิการ ดังต่อไปนี้ ซึ่งบริษัทสงวนสิทธิในการปรับเปลี่ยนสวัสดิการเหล่านี้เป็นคราวๆ ไป
                    <div class="flex_detail_container">
            ...
            <div class="flex_detail_container">
                ...
                <div class="detail">
                    <B>ลาป่วย</B> พนักงานมีสิทธิลาป่วยได้ตามที่ระบุในข้อบังคับการทำงานบริษัทซึ่งไม่ขัดต่อกฎหมายแรงงานไทย
                </div>
            </div>
            <div class="flex_detail_container">
                <div class="num">5.2</div>
                <div class="detail">
                    <B>วันหยุดตามเพณี</B> พนักงานมีสิทธิได้รับค่าจ้างในวันหยุดตามเพณีตามประกาศของบริษัทซึ่งไม่ขัดต่อกฎหมายแรงงานไทย
                </div>
            </div>
            <div class="flex_detail_container">
                <div class="num">5.3</div>
                <div class="detail">
                    <B>วันหยุดพักผ่อนประจำปี</B> พนักงานมีสิทธิหยุดพักผ่อนประจำปีตามที่ระบุในนโยบายและข้อบังคับการทำงานบริษัท
                </div>
            </div>
            ...
            <div class="flex_detail_container">
                ...
                <div class="detail">
                    <B>การบอกกล่าว</B> การบอกกล่าวใดๆ จะต้องส่งเป็นลายลักษณ์อักษรให้คู่สัญญาอีกฝ่าย
            ...
            <div class="flex_detail_container">
                ...
                <div class="detail">
                    <B>สัญญาโมฆะบางส่วน</B> หากบางส่วนของสัญญาเป็นโมฆะ ไม่ชอบด้วยกฎหมาย
            ...
            <div class="flex_detail_container">
                ...
                <div class="detail">
                    <B>การสละสิทธิ</B> หากคู่สัญญาฝ่ายใดฝ่ายหนึ่งไม่บังคับใช้หรือไม่ใช้สิทธิ
            ...
            <div class="flex_detail_container">
                ...
                <div class="detail">
                    <B>ผู้สืบสันดานและผู้รับมอบอำนาจ</B>
...
<script>
    function downloadPdf() {
        ...
        window.print();
        location.replace('/pdf/employment_form');
    }
</script>